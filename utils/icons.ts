const iconsSchema = {
  iconDefinitions: {
    ...
    _file_light: { iconPath: '/icons/file_light.svg' },
    ...
    _folder_light_open: { iconPath: '/icons/folder_light_open.svg' },
    _root_folder: { iconPath: '/icons/root_folder.svg' },
    _root_folder_open: { iconPath: '/icons/root_folder_open.svg' },
    _root_folder_light: { iconPath: '/icons/root_folder_light.svg' },
    _root_folder_light_open: {
      iconPath: '/icons/root_folder_light_open.svg',
    },
    _f_elm: { iconPath: '/icons/elm.svg' },
    _f_sass: { iconPath: '/icons/sass.svg' },
    _f_scss: { iconPath: '/icons/scss.svg' },
    _f_less: { iconPath: '/icons/less.svg' },
    _f_stylus: { iconPath: '/icons/stylus.svg' },
    _f_postcssconfig: { iconPath: '/icons/postcssconfig.svg' },
    _f_docker: { iconPath: '/icons/docker.svg' },
    _f_dockerignore: { iconPath: '/icons/dockerignore.svg' },
    _f_dockerdebug: { iconPath: '/icons/dockerdebug.svg' },
    _f_git: { iconPath: '/icons/git.svg' },
    _f_readme: { iconPath: '/icons/readme.svg' },
    _f_html: { iconPath: '/icons/html.svg' },
    _f_json: { iconPath: '/icons/json.svg' },
    _f_rjson: { iconPath: '/icons/rjson.svg' },
    _f_markdown: { iconPath: '/icons/markdown.svg' },
    _f_css: { iconPath: '/icons/css.svg' },
    _f_cssmap: { iconPath: '/icons/cssmap.svg' },
    _f_js: { iconPath: '/icons/js.svg' },
    _f_jsmap: { iconPath: '/icons/jsmap.svg' },
    _f_typescript: { iconPath: '/icons/typescript.svg' },
    _f_typescriptdef: { iconPath: '/icons/typescriptdef.svg' },
    _f_tsx: { iconPath: '/icons/tsx.svg' },
    _f_vue: { iconPath: '/icons/vue.svg' },
    _f_image: { iconPath: '/icons/image.svg' },
    _f_zip: { iconPath: '/icons/zip.svg' },
    _f_yarn: { iconPath: '/icons/yarn.svg' },
    _f_yarnerror: { iconPath: '/icons/yarnerror.svg' },
    _f_error: { iconPath: '/icons/error.svg' },
    _f_npm: { iconPath: '/icons/npm.svg' },
    _f_npmlock: { iconPath: '/icons/npmlock.svg' },
    _f_svg: { iconPath: '/icons/svg.svg' },
    _f_yaml: { iconPath: '/icons/yaml.svg' },
    _f_fontwoff2: { iconPath: '/icons/fontwoff2.svg' },
    _f_fontwoff: { iconPath: '/icons/fontwoff.svg' },
    _f_fontttf: { iconPath: '/icons/fontttf.svg' },
    _f_fontotf: { iconPath: '/icons/fontotf.svg' },
    _f_php: { iconPath: '/icons/php.svg' },
    _f_twig: { iconPath: '/icons/twig.svg' },
    _f_composer: { iconPath: '/icons/composer.svg' },
    _f_composerlock: { iconPath: '/icons/composerlock.svg' },
    _f_symfony: { iconPath: '/icons/symfony.svg' },
    _f_xml: { iconPath: '/icons/xml.svg' },
    _f_robots: { iconPath: '/icons/robots.svg' },
    _f_bundler: { iconPath: '/icons/bundler.svg' },
    _f_stylelint: { iconPath: '/icons/stylelint.svg' },
    _f_prettier: { iconPath: '/icons/prettier.svg' },
    _f_prettierignore: { iconPath: '/icons/prettierignore.svg' },
    _f_python: { iconPath: '/icons/python.svg' },
    _f_log: { iconPath: '/icons/log.svg' },
    _f_license: { iconPath: '/icons/license.svg' },
    _f_audio: { iconPath: '/icons/audio.svg' },
    _f_audiomp3: { iconPath: '/icons/audiomp3.svg' },
    _f_audioogg: { iconPath: '/icons/audioogg.svg' },
    _f_audiowav: { iconPath: '/icons/audiowav.svg' },
    _f_lua: { iconPath: '/icons/lua.svg' },
    _f_csharp: { iconPath: '/icons/csharp.svg' },
    _f_dartlang: { iconPath: '/icons/dartlang.svg' },
    ...
    _f_erb: { iconPath: '/icons/erb.svg' },
    _f_jest: { iconPath: '/icons/jest.svg' },
    _f_babel: { iconPath: '/icons/babel.svg' },
    _f_toml: { iconPath: '/icons/toml.svg' },
    _f_elixir: { iconPath: '/icons/elixir.svg' },
    _f_exs: { iconPath: '/icons/exs.svg' },
    _f_rust: { iconPath: '/icons/rust.svg' },
    _f_rustfmt: { iconPath: '/icons/rustfmt.svg' },
    _f_reactjs: { iconPath: '/icons/reactjs.svg' },
    _f_reactts: { iconPath: '/icons/reactts.svg' },
    ...
    _f_editorconfig: { iconPath: '/icons/editorconfig.svg' },
    _f_light_editorconfig: {
      iconPath: '/icons/light_editorconfig.svg',
    },
    _f_shell: { iconPath: '/icons/shell.svg' },
    _f_vscode: { iconPath: '/icons/vscode.svg' },
    _f_ai: { iconPath: '/icons/ai.svg' },
    _f_photoshop: { iconPath: '/icons/photoshop.svg' },
    _f_pdf: { iconPath: '/icons/pdf.svg' },
    _f_go: { iconPath: '/icons/go.svg' },
    _f_go_package: { iconPath: '/icons/go_package.svg' },
    _f_tmpl: { iconPath: '/icons/tmpl.svg' },
    _f_svelte: { iconPath: '/icons/svelte.svg' },
    _f_browserslist: { iconPath: '/icons/browserslist.svg' },
    _f_erlang: { iconPath: '/icons/erlang.svg' },
    _f_vite: { iconPath: '/icons/vite.svg' },
    _f_mint: { iconPath: '/icons/mint.svg' },
    _f_eex: { iconPath: '/icons/eex.svg' },
    _f_env: { iconPath: '/icons/env.svg' },
    _f_nvm: { iconPath: '/icons/nvm.svg' },
    _f_sql: { iconPath: '/icons/sql.svg' },
    _f_nginx: { iconPath: '/icons/nginx.svg' },
    _f_conf: { iconPath: '/icons/conf.svg' },
    _f_c: { iconPath: '/icons/c.svg' },
    _f_cpp: { iconPath: '/icons/cpp.svg' },
    _f_hpp: { iconPath: '/icons/hpp.svg' },
    _f_powershell: { iconPath: '/icons/powershell.svg' },
    _f_powershelldata: { iconPath: '/icons/powershelldata.svg' },
    _f_powershellmodule: { iconPath: '/icons/powershellmodule.svg' },
    _f_njk: { iconPath: '/icons/njk.svg' },
    _f_blade: { iconPath: '/icons/blade.svg' },
    _f_liquid: { iconPath: '/icons/liquid.svg' },
    _f_pug: { iconPath: '/icons/pug.svg' },
    _f_cheader: { iconPath: '/icons/cheader.svg' },
    _f_m: { iconPath: '/icons/m.svg' },
    _f_swift: { iconPath: '/icons/swift.svg' },
    _f_graphql: { iconPath: '/icons/graphql.svg' },
    _f_groovy: { iconPath: '/icons/groovy.svg' },
    _f_testjs: { iconPath: '/icons/testjs.svg' },
    _f_testts: { iconPath: '/icons/testts.svg' },
    _f_storybook: { iconPath: '/icons/storybook.svg' },
    _f_wasm: { iconPath: '/icons/wasm.svg' },
    _f_imagepng: { iconPath: '/icons/imagepng.svg' },
    _f_imagejpg: { iconPath: '/icons/imagejpg.svg' },
    _f_imagegif: { iconPath: '/icons/imagegif.svg' },
    _f_imagewebp: { iconPath: '/icons/imagewebp.svg' },
    _f_imageico: { iconPath: '/icons/imageico.svg' },
    _f_cli: { iconPath: '/icons/cli.svg' },
    _f_bat: { iconPath: '/icons/bat.svg' },
    _f_nuxt: { iconPath: '/icons/nuxt.svg' },
    _f_netlify: { iconPath: '/icons/netlify.svg' },
    _f_vercel: { iconPath: '/icons/vercel.svg' },
    _f_tailwind: { iconPath: '/icons/tailwind.svg' },
    _f_windi: { iconPath: '/icons/windi.svg' },
    _f_nodemon: { iconPath: '/icons/nodemon.svg' },
    _f_jinja: { iconPath: '/icons/jinja.svg' },
    _f_haml: { iconPath: '/icons/haml.svg' },
    _f_smarty: { iconPath: '/icons/smarty.svg' },
    _f_haskell: { iconPath: '/icons/haskell.svg' },
    _f_gradle: { iconPath: '/icons/gradle.svg' },
    _f_nim: { iconPath: '/icons/nim.svg' },
    _f_nestjs: { iconPath: '/icons/nestjs.svg' },
    _f_nestjscontroller: { iconPath: '/icons/nestjscontroller.svg' },
    _f_nestjsservice: { iconPath: '/icons/nestjsservice.svg' },
    _f_nestjsmodule: { iconPath: '/icons/nestjsmodule.svg' },
    _f_nestjsguard: { iconPath: '/icons/nestjsguard.svg' },
    _f_nestjsdecorator: { iconPath: '/icons/nestjsdecorator.svg' },
    _f_nestjsfilter: { iconPath: '/icons/nestjsfilter.svg' },
    _f_jenkins: { iconPath: '/icons/jenkins.svg' },
    _f_txt: { iconPath: '/icons/txt.svg' },
    _f_binary: { iconPath: '/icons/binary.svg' },
    _f_cert: { iconPath: '/icons/cert.svg' },
    _f_key: { iconPath: '/icons/key.svg' },
    _f_prisma: { iconPath: '/icons/prisma.svg' },
    _f_compodoc: { iconPath: '/icons/compodoc.svg' },
    _f_julia: { iconPath: '/icons/julia.svg' },
    _f_csv: { iconPath: '/icons/csv.svg' },
    _f_karma: { iconPath: '/icons/karma.svg' },
    _f_tsconfig: { iconPath: '/icons/tsconfig.svg' },
    _f_travis: { iconPath: '/icons/travis.svg' },
    _f_razor: { iconPath: '/icons/razor.svg' },
    _f_cshtml: { iconPath: '/icons/cshtml.svg' },
    _f_jsp: { iconPath: '/icons/jsp.svg' },
    _f_avi: { iconPath: '/icons/avi.svg' },
    _f_mp4: { iconPath: '/icons/mp4.svg' },
    _f_mov: { iconPath: '/icons/mov.svg' },
    _f_video: { iconPath: '/icons/video.svg' },
    _f_rescript: { iconPath: '/icons/rescript.svg' },
    _f_bsconfig: { iconPath: '/icons/bsconfig.svg' },
    _f_opengl: { iconPath: '/icons/opengl.svg' },
    _f_llvm: { iconPath: '/icons/llvm.svg' },
    _f_info: { iconPath: '/icons/info.svg' },
    _f_ipynb: { iconPath: '/icons/ipynb.svg' },
    _f_sol: { iconPath: '/icons/sol.svg' },
    _f_bicep: { iconPath: '/icons/bicep.svg' },
    _f_qt: { iconPath: '/icons/qt.svg' },
    _f_ui: { iconPath: '/icons/ui.svg' },
    _f_prolog: { iconPath: '/icons/prolog.svg' },
    _f_user: { iconPath: '/icons/user.svg' },
    _f_clojure: { iconPath: '/icons/clojure.svg' },
    _f_terraform: { iconPath: '/icons/terraform.svg' },
    _f_terraformvars: { iconPath: '/icons/terraformvars.svg' },
    _f_parcel: { iconPath: '/icons/parcel.svg' },
    _f_ocaml: { iconPath: '/icons/ocaml.svg' },
    _f_ocamli: { iconPath: '/icons/ocamli.svg' },
    _f_ocamly: { iconPath: '/icons/ocamly.svg' },
    _f_ocamll: { iconPath: '/icons/ocamll.svg' },
    _f_fsharp: { iconPath: '/icons/fsharp.svg' },
    _f_dune: { iconPath: '/icons/dune.svg' },
    _f_duneproject: { iconPath: '/icons/duneproject.svg' },
    _f_adonis: { iconPath: '/icons/adonis.svg' },
    _f_adonisconfig: { iconPath: '/icons/adonisconfig.svg' },
    _f_astro: { iconPath: '/icons/astro.svg' },
    _f_astroconfig: { iconPath: '/icons/astroconfig.svg' },
    _f_godot: { iconPath: '/icons/godot.svg' },
    _f_tscn: { iconPath: '/icons/tscn.svg' },
    _f_svelteconfig: { iconPath: '/icons/svelteconfig.svg' },
    _f_toolversions: { iconPath: '/icons/toolversions.svg' },
    _f_cmake: { iconPath: '/icons/cmake.svg' },
    _f_conan: { iconPath: '/icons/conan.svg' },
    _f_cargo: { iconPath: '/icons/cargo.svg' },
    _f_cargolock: { iconPath: '/icons/cargolock.svg' },
    _f_pnpm: { iconPath: '/icons/pnpm.svg' },
    _f_pnpmlock: { iconPath: '/icons/pnpmlock.svg' },
    _f_tauri: { iconPath: '/icons/tauri.svg' },
    _f_todo: { iconPath: '/icons/todo.svg' },
    _f_nextconfig: { iconPath: '/icons/nextconfig.svg' },
    _f_nextron: { iconPath: '/icons/nextron.svg' },
    _f_hashicorp: { iconPath: '/icons/hashicorp.svg' },
    _f_sentinel: { iconPath: '/icons/sentinel.svg' },
    _f_poetry: { iconPath: '/icons/poetry.svg' },
    _f_poetrylock: { iconPath: '/icons/poetrylock.svg' },
    _f_pyproject: { iconPath: '/icons/pyproject.svg' },
    _f_cucumber: { iconPath: '/icons/cucumber.svg' },
    _f_nix: { iconPath: '/icons/nix.svg' },
    _f_flakelock: { iconPath: '/icons/flakelock.svg' },
    _f_edge: { iconPath: '/icons/edge.svg' },
    _f_ace: { iconPath: '/icons/ace.svg' },
    _f_acemanifest: { iconPath: '/icons/acemanifest.svg' },
    _f_sqlite: { iconPath: '/icons/sqlite.svg' },
    _f_knex: { iconPath: '/icons/knex.svg' },
    _f_launch: { iconPath: '/icons/launch.svg' },
    _f_redis: { iconPath: '/icons/redis.svg' },
    _f_nvim: { iconPath: '/icons/nvim.svg' },
    _f_sequelize: { iconPath: '/icons/sequelize.svg' },
    _f_tres: { iconPath: '/icons/tres.svg' },
    _f_sln: { iconPath: '/icons/sln.svg' },
    _f_suo: { iconPath: '/icons/suo.svg' },
    _f_csproj: { iconPath: '/icons/csproj.svg' },
    _f_mesh: { iconPath: '/icons/mesh.svg' },
    _f_gbl: { iconPath: '/icons/gbl.svg' },
    _f_cypress: { iconPath: '/icons/cypress.svg' },
    _f_playright: { iconPath: '/icons/playright.svg' },
    _f_vitest: { iconPath: '/icons/vitest.svg' },
    _f_flutter: { iconPath: '/icons/flutter.svg' },
    _f_flutterlock: { iconPath: '/icons/flutterlock.svg' },
    _f_flutterpackage: { iconPath: '/icons/flutterpackage.svg' },
    _f_htaccess: { iconPath: '/icons/htaccess.svg' },
    _f_nx: { iconPath: '/icons/nx.svg' },
    _f_v: { iconPath: '/icons/v.svg' },
    _f_vmod: { iconPath: '/icons/vmod.svg' },
    _f_rego: { iconPath: '/icons/rego.svg' },
    _f_scala: { iconPath: '/icons/scala.svg' },
    _f_d: { iconPath: '/icons/d.svg' },
    _f_adoc: { iconPath: '/icons/adoc.svg' },
    _f_motoko: { iconPath: '/icons/motoko.svg' },
    _f_diff: { iconPath: '/icons/diff.svg' },
    _f_quasar: { iconPath: '/icons/quasar.svg' },
  },
  fileExtensions: {
    'wma': '_f_audio',
    'wav': '_f_audiowav',
