...
<template>
  <header class="flex h-[60px] flex-shrink-0 items-center gap-1 px-4 drag" style="-webkit-app-region:drag">
    ...
    <Flex justify-content="end" align-items="center" class="gap-3">
      <ThemeToggle />
